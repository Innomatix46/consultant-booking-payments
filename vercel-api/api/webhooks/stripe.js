...
const handler = async (req, res) => {
  ...
  if (Buffer.isBuffer(req.body)) {
    ...
    eventBody = Buffer.from(JSON.stringify(req.body));
  }
  ...
  try {
    ...
    logWebhookEvent('stripe', result, true);
    ...
    logWebhookEvent('stripe', { type: 'error' }, false, error);
